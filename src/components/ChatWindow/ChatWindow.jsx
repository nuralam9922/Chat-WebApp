  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="px-4 py-2 text-primaryTextColor  flex-grow"
      >
  ...
  return (
    <nav className="w-full navbar h-16 flex-shrink-0 absolute top-0 left-0 flex items-center justify-between px-4 bg-backgroundColor text-primaryTextColor">
      <div className="flex items-center gap-2">
        ...
        <div>
          <div className="font-medium text-primaryTextColor flex items-center gap-2 text-sm">{name}<span>{userName}</span></div>
