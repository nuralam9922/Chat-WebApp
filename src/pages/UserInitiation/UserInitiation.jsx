...
function UserOnboarding({ setNewUser }) {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center">
      <div className=" w-full h-full  p-3 md:p-10  ">
        ...
        {step === 2 && <div className='w-full flex justify-center lg:max-w-[400px] mx-auto'>
          <EditProfile navigateLink={'/'} setNewUser={setNewUser} />
        </div>}
      </div>
    </div>
  );
