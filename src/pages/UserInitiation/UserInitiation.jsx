    ...
    <div className="w-full h-screen flex items-center justify-center">
      <div className=" w-full h-full border-2 p-3 md:p-10  ">
        ...
        <div className="flex justify-between py-5">
          <svg className="w-20" viewBox="0 0 350 212.909198897464">
          ...
          <button className="text-linkColor py-2 underline underline-offset-4 cursor-pointer" onClick={() => (step < 3 ? setStep(step + 1) : navigate('/'))}>
            Skip
          </button>
        </div>
        {step === 1 && <WelcomeSection onNextStep={nextStep} />}
        {step === 2 && <EditProfile onNextStep={nextStep} />}
        {step === 3 && <UserSetting />}
      </div>
    </div>
  );
