...
export const Privacy = ({ currentSetting, setCurrentSetting }) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-20 flex flex-col gap-4  cursor-pointer">
        <div onClick={() => setCurrentPrivacySetting('Last Seen')} className="w-full h-16 border-b-2 flex justify-between items-center">
          <div>
            <h1>Last Seen</h1>
        ...
        <div onClick={() => setCurrentPrivacySetting('Profile Photo')} className="w-full h-16 border-b-2 flex justify-between items-center">
          <div>
            <h1>Profile Photo</h1>
            <p className="text-sm text-secondaryTextColor">Everyone</p>
          </div>
        ...
        <div onClick={() => setCurrentPrivacySetting('About')} className="w-full h-16 border-b-2 flex justify-between items-center">
          <div>
            <h1>About</h1>
            <p className="text-sm text-secondaryTextColor">Everyone</p>
          </div>
        ...
        <div className="w-full min-h-16 border-b-2 flex justify-between items-center">
          <div>
            <h1>Read receipts</h1>
        ...
        <div onClick={() => setCurrentPrivacySetting('Blocked Contacts')} className="w-full h-16 border-b-2 flex justify-between items-center">
          <div>
